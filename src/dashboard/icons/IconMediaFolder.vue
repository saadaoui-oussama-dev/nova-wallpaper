<template>
	<svg fill="none" width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
		<path
		...
		/>
		<path d="M19.5 14.51L19.51 14.4989" :stroke="color" stroke-linecap="round" stroke-linejoin="round" />
		<path d="M13 18.2L16.5 17L22 19" :stroke="color" stroke-linecap="round" stroke-linejoin="round" />
		<path
