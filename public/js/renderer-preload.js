...
const useDialog = (() => {
	...
	const setStyles = (target, source, selector, args) => {
		const getStyles = (styles) =>
			typeof styles === 'function' ? styles(args || {}) : typeof styles === 'object' ? styles : undefined;
		Object.assign(target.style, {
			...(styles && getStyles(styles[selector])),
			...getStyles(source && source[selector]),
		});
	};

	function createButton(button, value, styles, defaultButton, response) {
	...
	function useDialog(title, options) {
